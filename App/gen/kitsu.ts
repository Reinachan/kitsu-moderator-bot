...
export type ReportFragment = {
  ...
  readonly naughty?:
    | {
        ...
        readonly post: { readonly __typename?: 'Post'; readonly id: string };
      }
    | {
        readonly __typename: 'MediaReaction';
        readonly id: string;
...
export type ReportPartialFragment = {
  readonly __typename?: 'Report';
  readonly createdAt: Date;
  readonly id: string;
  readonly status: ReportStatusEnum;
...
export const ReportFragmentDoc = gql`
  ...
  ${MediaFragmentDoc}
`;
export const ReportPartialFragmentDoc = gql`
...
export function getSdk(
  ...
  return {
    ...
    ReportsPartial(
      variables: ReportsPartialQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<ReportsPartialQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ReportsPartialQuery>(
            ReportsPartialDocument,
            variables,
...
const result: PossibleTypesResultData = {
  possibleTypes: {
    ...
    AmountConsumed: ['AnimeAmountConsumed', 'MangaAmountConsumed'],
    CategoryBreakdown: ['AnimeCategoryBreakdown', 'MangaCategoryBreakdown'],
    Episodic: ['Anime'],
    Error: ['GenericError', 'ValidationError'],
    FavoriteItemUnion: ['Anime', 'Character', 'Manga', 'Person'],
    MappingItemUnion: [
      'Anime',
      'Category',
      'Character',
    ...
    Media: ['Anime', 'Manga'],
    ReportItemUnion: ['Comment', 'MediaReaction', 'Post', 'Review'],
    Streamable: ['StreamingLink', 'Video'],
